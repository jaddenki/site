...
export default function BioCard() {
  ...
  return (
      ...
      <button
        ...
        className="mt-6 flex items-center gap-2 text-secondary hover:text-accent transition-colors font-['PolySans-Neutral'] text-sm group"
      >
      ...
      <div className={`extended-bio overflow-hidden transition-all duration-500 ease-out ${isExpanded ? 'max-h-[2000px] opacity-100 mt-6' : 'max-h-0 opacity-0'}`}>
        <div className="space-y-6">
              ...
              <p className="text-lg leading-relaxed">
                During Summer 2025, I worked as a <span className="text-accent font-medium">software programmer</span> on a Purdue-affiliated research grant (<span className="text-accent font-medium">SBIR Phase I</span>), helping prototype a platform for improving Air Force operations and decision workflows. It involved full-stack development, frontend UX design, and backend tooling focused on performance and usability
              </p>
              ...
              <p className="text-lg leading-relaxed">
                I also do work as a <span className="text-accent font-medium">freelance video editor</span>; I love the challenge of taking ideas and turning them into something that tells <span className="text-accent font-medium">more</span>. It's taught me a lot about pacing, visual storytelling, and how to work with clients to bring their vision to life
              </p>

              <p className="text-lg leading-relaxed">
                Outside of all of that, you'll find me watching deep dive analyses of Reddit threads 
                and horror games, developing <a href="https://fruitjamms.github.io/" target="_blank" rel="noopener noreferrer" className="text-accent font-medium hover:underline">games</a> with friends, <a href= "https://www.instagram.com/igarakii/" target="_blank" rel="noopener noreferrer" className="text-accent font-medium hover:underline">editing a video</a> that strains my own eyes, or logging my thoughts on <a href="https://letterboxd.com/jaddenki/" target="_blank" rel="noopener noreferrer" className="text-accent font-medium hover:underline">movies</a>
              </p>
